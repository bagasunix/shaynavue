            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="ft_product" alt="" />
                </div>
                <div class="product-thumbs">
                  ...
                  >
                    <div
                      ...
                      :class="thumbs[0] == ft_product ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[1] == ft_product ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[2] == ft_product ? 'active' : ''"
                    >
                    ...
                    <div
                      ...
                      :class="thumbs[3] == ft_product ? 'active' : ''"
                    >
...
import FotterShayna from "@/components/FotterShayna.vue";
